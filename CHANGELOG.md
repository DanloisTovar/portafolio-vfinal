...
- chore(changelog): 📝 actualizar CHANGELOG ([9da6bb9](https://github.com/DanloisTovar/portafolio-vfinal/commit/9da6bb9))
- chore(changelog): 📝 actualizar CHANGELOG ([e27bc18](https://github.com/DanloisTovar/portafolio-vfinal/commit/e27bc18))
...
- chore(hygiene): 🔧 gitignore archivos personales y análisis CV ([6f8fc6c](https://github.com/DanloisTovar/portafolio-vfinal/commit/6f8fc6c))
...
- feat(seo): 🔍 agregar meta tag de verificación de Google Search Console ([48ef01e](https://github.com/DanloisTovar/portafolio-vfinal/commit/48ef01e))
...
- fix(ci): 🐛 replicar CI de EventTwo — pnpm@10 via action-setup ([4f48332](https://github.com/DanloisTovar/portafolio-vfinal/commit/4f48332))
...
- fix(ci): 🔍 verbose output para debuggear qué test falla ([9e25583](https://github.com/DanloisTovar/portafolio-vfinal/commit/9e25583))
...
- fix(responsive): 📱 aplicar max-w-full en tags WordPress móvil/tablet ([1de5505](https://github.com/DanloisTovar/portafolio-vfinal/commit/1de5505))
...
- docs: 📝 agregar pendientes próxima sesión ([b8187f6](https://github.com/DanloisTovar/portafolio-vfinal/commit/b8187f6))
